...
public class CommentRestAPI {
    ...
    public ResponseEntity<?> createComment(@RequestBody Comment comment) {
        Optional<Song> product = productService.findById(comment.getIdSong());
    ...
    public ResponseEntity<?> getAllCommentBySong(@PathVariable Long id) {
